...
int RGWSI_Cls::MFA::check_mfa(const DoutPrefixProvider *dpp,
  ...
  r = rados::cls::otp::OTP::check(cct, ref.ioctx, ref.obj.oid, otp_id, pin,
                                  &result);
  if (r < 0)
    return r;
...
int RGWSI_Cls::MFA::get_mfa(const DoutPrefixProvider *dpp, const rgw_user &user,
                            const string &id,
...
int RGWSI_Cls::TimeLog::init_obj(const DoutPrefixProvider *dpp,
                                 const string &oid, rgw_rados_ref &obj) {
  rgw_raw_obj o(cls->zone_svc->get_zone_params().log_pool, oid);
  return rgw_get_rados_ref(dpp, cls->rados, o, &obj);
}

int RGWSI_Cls::TimeLog::add(const DoutPrefixProvider *dpp, const string &oid,
                            const real_time &ut, const string &section,
...
int RGWSI_Cls::TimeLog::list(const DoutPrefixProvider *dpp, const string &oid,
...
int RGWSI_Cls::TimeLog::info(const DoutPrefixProvider *dpp, const string &oid,
...
int RGWSI_Cls::TimeLog::info_async(const DoutPrefixProvider *dpp,
                                   rgw_rados_ref &obj, const string &oid,
...
int RGWSI_Cls::TimeLog::trim(const DoutPrefixProvider *dpp, const string &oid,
                             const real_time &start_time,
...
int RGWSI_Cls::Lock::unlock(const DoutPrefixProvider *dpp, const rgw_pool &pool,
                            const string &oid, string &zone_id,
